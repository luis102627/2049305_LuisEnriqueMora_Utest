...
public class EnterInformationWith implements Task {
    ...
    public EnterInformationWith(List<PersonalInformation>data){
    ...
    public <T extends Actor> void performAs(T actor) {
        actor.attemptsTo(Enter.theValue(firstName).into(RegistrationForm.TXT_FIRSTNAME),
                ...
                WaitUntil.the(RegistrationForm.ALERT_DIFFERENT_KEYS, WebElementStateMatchers.isVisible()).forNoMoreThan(60).seconds());
    }

    public static EnterInformationWith differentKeys(List<PersonalInformation>data){
        return instrumented(EnterInformationWith.class,data);
    }
}
