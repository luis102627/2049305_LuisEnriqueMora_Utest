...
public class TypeInformation implements Task {
    ...
    public TypeInformation(List<PersonalInformation> data) {
    ...
    public static TypeInformation inTheFirtsForm(List<PersonalInformation> data) {
        return instrumented(TypeInformation.class,data);
    }
}
