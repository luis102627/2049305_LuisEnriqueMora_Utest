...
public class AddInformation implements Task {
    ...
    public AddInformation(List<PersonalInformation>data){
    ...
    public static AddInformation theFirstTwoForms(List<PersonalInformation> data){
        return instrumented(AddInformation.class,data);
    }
}
